                ...
                <div class="modal-dialog modal-md">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <input type="submit" name="done" id="done" value="Done" class="btn btn-outline-primary btn-sm hiddenButton" />
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <a href="<?php echo base_url('trobleshoot/delete_data_troble/'); echo $u->idPenanganan; ?>" onclick="return confirmation();" class="btn btn-sm btn-danger " style="padding: 5px 7px"><i class="fa fa-trash"></i></a>
                                                        </td>
                                                    </tr>
                                                    <?php } ?>
                                                </tbody>
