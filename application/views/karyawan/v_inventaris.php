                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control form-control-sm" id="Desc" name="Desc" rows="4" cols="50">
                                </textarea>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <button type="button" class="btn btn-outline-primary btn-sm add_data_inventaris" style="margin-bottom: 10px;" data-toggle="modal" data-target="#modalInventaris">Tambah Baru</button>
