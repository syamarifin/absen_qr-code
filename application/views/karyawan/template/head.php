<head>
    ...
    $(document).ready(function() {
      ...
      if (page == 'dashboard') {
      ...
      }else if (page == 'view_absensiKabid') {
      ...
      }else if (page == 'view_troble' || page =='simpan_troble') {
        $("#dash").removeClass("active");
        $("#absen").removeClass("active");
        ...
        $("#pinjam").removeClass("active");
        $("#hots").removeClass("active");
      }else if (page == 'view_anggota' || page =='simpan_anggota') {
        $("#dash").removeClass("active");
        $("#absen").removeClass("active");
        $("#trobel").removeClass("active");
        ...
        $("#pinjam").removeClass("active");
        $("#hots").removeClass("active");
      }else if (page == 'view_inventaris' || page =='simpan_inventaris') {
        $("#dash").removeClass("active");
        $("#absen").removeClass("active");
        $("#trobel").removeClass("active");
        $("#anggota").removeClass("active");
