                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            ...
                                            <div class="input-group">
                                                <input type="text" class="form-control form-control-sm monthJadwal" id="Jadwal"name="Jadwal" value="<?php echo date('m-Y'); ?>" readonly aria-describedby="inputGroupPrepend" required="">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control form-control-sm" required name="Sift" id="Sift">
                                                    <option value="Pagi (07:00 s/d 13:00)">Pagi (07:00 s/d 13:00)</option>
                                                    <option value="Siang (11:00 s/d 17:00)">Siang (11:00 s/d 17:00)</option>
                                                    <option value="Sore (15:00 s/d 21:00)">Sore (15:00 s/d 21:00)</option>
                                                </select>
                                            </div>
                                        </div>
                                        <!-- <div class="col-sm-4">
                                            <label for="example-text-input-sm" class="col-form-label">Masuk</label>
                                            <div class="form-group">
                                                <input class="form-control form-control-sm" type="time" value="09:00:00" id="Masuk" name="Masuk">
                                            </div>
                                            <div class="form-group">
                                                <label for="example-text-input-sm" class="col-form-label">Keluar</label>
                                                <input class="form-control form-control-sm" type="time" value="13:45:00" id="Keluar" name="Keluar">
                                            </div>
                                        </div> -->
                                        <div class="col-lg-12">
