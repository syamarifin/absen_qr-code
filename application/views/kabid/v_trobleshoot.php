                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-6 col-sm-8 clearfix">
                        ...
                        <div class="search-box pull-left">
                            <form action="">
                                <input type="text" name="search" id="search" placeholder="Search by problem" required>
                                <i class="ti-search"></i>
                            </form>
                        </div>
                    </div>
            ...
            <div class="modal fade" id="modalTroble">
                <div class="modal-dialog modal-md">
                    <div class="modal-content">
                        ...
                        <form method="post" class="needs-validation" onsubmit="return validasi_input(this)" action="<?php echo base_url('trobleshoot/simpan_trobleKabid')?>">
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control form-control-sm" id="Description" name="Description" rows="4" cols="50" required></textarea>
                            </div>
                        </div>
            ...
            <div class="modal fade" id="modalLaporan">
                <div class="modal-dialog modal-md">
                    <div class="modal-content">
                        ...
                        <form method="post" class="needs-validation" action="<?php echo base_url('trobleshoot/view_trobleDone')?>">
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <textarea class="form-control form-control-sm" id="solusi" name="solusi" rows="4" cols="50">
                                            </textarea>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="tab-content mt-3" id="myTabContent">
                                        <div class="tab-pane fade show active" id="new" role="tabpanel" aria-labelledby="new-tab">
                                            <!-- <h4 class="header-title" style="text-align: center;">Data Troubleshooting Baru</h4> -->
                                            ...
                                            <!-- <button type="button" class="btn btn-outline-primary btn-sm add_data_troble" style="margin-bottom: 10px;" data-toggle="modal" data-target="#modalLaporan">Cetak ke PDF</button> -->
                                            <!-- <a href="<?php echo base_url('trobleshoot/printTroubleNew');?>" class="btn btn-outline-primary btn-sm " style="margin-bottom: 10px;">Cetak ke PDF</a> -->
                                                                ...
                                                                <td>
                                                                    <div class="btn-group">
                                                                        ...
                                                                        <div class="dropdown-menu">
                                                                            ...
                                                                            <a href="<?php echo base_url('trobleshoot/delete_data_trobleKabid/'); echo $u->idPenanganan; ?>" onclick="return confirmation();" class="dropdown-item " style="padding: 5px 7px"><i class="fa fa-trash"></i> Delete</a>
                                                                            ...
                                                                            <!-- <button type="submit" name="view" value="edit" id="<?php echo $u->idPenanganan ?>" class="dropdown-item done_data_troble" style="padding: 5px 7px"><i class="fa fa-check-square-o"></i> Done</button> -->
                                                                        </div>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                        ...
                                        <div class="tab-pane fade" id="done" role="tabpanel" aria-labelledby="done-tab">
                                            <!-- <a href="<?php echo base_url('trobleshoot/printTroubleDone');?>" class="btn btn-outline-primary btn-sm " style="margin-bottom: 10px;">Cetak ke PDF</a> -->
