            ...
            <div class="modal fade" id="modalTroble">
                <div class="modal-dialog modal-md">
                    <div class="modal-content">
                        ...
                        <form method="post" class="needs-validation" onsubmit="return validasi_input(this)" action="<?php echo base_url('anggota/simpan_anggotaKabid')?>">
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control form-control-sm" id="Alamat" name="Alamat" rows="4" cols="50">
                                </textarea>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <button type="button" class="btn btn-outline-primary btn-sm" style="margin-bottom: 10px;" data-toggle="modal" data-target="#modalTroble">Tambah Baru</button>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <a href="<?php echo base_url('anggota/jadikanAslabKabid/'); echo $u->IdDaftar_a; ?>" class="btn btn-sm btn-danger " style="padding: 5px 7px">Jadikan aslab</a>
                                                        </td>
                                                    </tr>
                                                    <?php } ?>
                                                </tbody>
