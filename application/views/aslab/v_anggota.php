            ...
            <div class="modal fade" id="modalTroble">
                <div class="modal-dialog modal-md">
                    <div class="modal-content">
                        ...
                        <form method="post" class="needs-validation" onsubmit="return validasi_input(this)" action="<?php echo base_url('anggota/simpan_anggotaAslab')?>">
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label for="example-text-input-sm" class="col-form-label">NIM</label>
                                        <input class="form-control form-control-sm" type="text" placeholder="No Induk Mahasiswa" id="NIM" name="NIM" value="" onkeypress="return hanyaAngka(event)">
                                    </div>
                                    <div class="form-group">
                                        <label for="example-text-input-sm" class="col-form-label">Semester</label>
                                        <input class="form-control form-control-sm" type="text" placeholder="Semester (dalam angka)" id="Semester" name="Semester" value="" onkeypress="return hanyaAngka(event)" >
                                    </div>
                                    <div class="form-group">
                                        <label for="example-text-input-sm" class="col-form-label">Tempat Lahir</label>
                                        <div class="input-group">
                                            <input type="text" class="form-control form-control-sm" id="Tempat" name="Tempat" value="" placeholder="Tempat Lahir">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control form-control-sm" type="text" placeholder="Nama" id="Nama" name="Nama" value="">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="text" class="form-control form-control-sm monthGl" id="Lahir" name="Lahir" value="" readonly aria-describedby="inputGroupPrepend" required="">
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <button type="button" class="btn btn-outline-primary btn-sm tambah_anggota" style="margin-bottom: 10px;" data-toggle="modal" data-target="#modalTroble">Tambah Baru</button>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <a href="<?php echo base_url('anggota/delete_data_anggotaAslab/'); echo $u->IdDaftar_a; ?>" onclick="return confirmation();" class="btn btn-sm btn-danger " style="padding: 5px 7px"><i class="fa fa-trash"></i></a>
                                                        </td>
                                                    </tr>
                                                    <?php } ?>
                                                </tbody>
