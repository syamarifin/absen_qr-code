            ...
            <div class="modal fade" id="modalPeminjaman">
                <div class="modal-dialog modal-sm">
                    <div class="modal-content">
                        ...
                        <form method="post" class="needs-validation" onsubmit="return validasi_input(this)" action="<?php echo base_url('peminjaman/simpan_peminjamanAslab')?>">
                                                    ...
                                                    <table class="table text-center">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <a href="<?php echo base_url('peminjaman/pengembalianAslab/'); echo $u->idPinjam; ?>" class="btn btn-sm btn-info " title="Pengembalian" style="padding: 5px 7px"><i class="fa fa-mail-reply" ></i></a>
                                                                    ...
                                                                    <a href="<?php echo base_url('peminjaman/add_peminjamanAslab/'); echo $u->idPinjam; ?>" class="btn btn-sm btn-info " title="Edit Detail" style="padding: 5px 7px"><i class="fa fa-file-text"></i></a>
                                                                </td>
                                                            </tr>
                                                            <?php } ?>
                                                        </tbody>
