            ...
            <div class="modal fade" id="modalTroble">
                <div class="modal-dialog modal-md">
                    <div class="modal-content">
                        ...
                        <form method="post" class="needs-validation" onsubmit="return validasi_input(this)" action="<?php echo base_url('trobleshoot/simpan_trobleAslabq')?>">
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <div class="btn-group">
                                                                        ...
                                                                        <div class="dropdown-menu">
                                                                            ...
                                                                            <a href="<?php echo base_url('trobleshoot/delete_data_trobleAslab/'); echo $u->idPenanganan; ?>" onclick="return confirmation();" class="dropdown-item " style="padding: 5px 7px"><i class="fa fa-trash"></i> Delete</a>
