                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <button type="button" class="btn btn-outline-primary btn-sm add_data_hotspot" style="margin-bottom: 10px;" data-toggle="modal" data-target="#exampleModalLong">Pendaftar Baru</button>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <!-- <button type="submit" name="view" value="edit" id="<?php echo $u->idDaftar_h ?>" class="btn btn-sm btn-danger delete_data_hotspot" style="padding: 5px 7px" onclick="confirmation();"><i class="fa fa-trash"></i> -->
                                                            <a href="<?php echo base_url('hotspot/delete_data_hotspot/'); echo $u->idDaftar_h; ?>" onclick="return confirmation();" class="btn btn-sm btn-danger " style="padding: 5px 7px"><i class="fa fa-trash"></i></a>
                                                            <a href="<?php echo base_url('hotspot/update_status_hotspot/'); echo $u->idDaftar_h; ?>" onclick="return confirmationApprove();" class="btn btn-sm btn-warning " style="padding: 5px 7px"><i class="ti-check-box"></i></a>
                                                        </td>
                                                    </tr>
                                                    <?php } ?>
                                                </tbody>
